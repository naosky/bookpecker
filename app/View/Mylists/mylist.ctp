...
<?php var_dump($user); ?>
	...
	<div class="col-lg-3">
		...
		<thead>
		<tr><th colspan="2">ユーザーID様</th></tr>
		</thead>
        <tbody>
        <tr><td colspan="2">
        <span class="text-danger">新刊が1冊出ています</span>
        <hr class="user-hr">所有タイトル数<span class="badge pull-right">7</span>
        <hr class="user-hr">完結タイトル数<span class="badge pull-right">4</span>
        <hr class="user-hr">合計冊数<span class="badge pull-right">156</span></td></tr>
        <tr class="table-footer"><td><small>最終更新日</small></td><td align="right"><small>2013/08/01</small></td></tr>
		</tbody>
        </table>
        
        <p>
        <a href="input.html"><button type="button" class="btn btn-default btn-block">書籍の登録</button></a>
    	</p>
	...
	<ul class="nav nav-tabs" id="myTab">
		<li class="active"><a href="#mylist">収集中リスト</a></li>
		<li><a href="#complete">CompleteList</a></li>
	</ul>
	...
	<div class="tab-content">
		...
		<!-- 所有リスト -->
	    <table class="table table-hover table-list table-striped">
		<tbody>
	    <tr class="warning" data-toggle="modal" href="#myModal">
	    <td class="img"><img class="img-thumbnail" src="img/ctitle/003.jpg"></td>
	    <td>
	    <dl>
	    <dt>バガボンド <span class="badge badge-n">34巻</span></dt>
	    <dd>井上 雄彦</dd>
	    <dd>モーニングKC／講談社 (2012/10/23)</dd>
	    <dd><span class="text-danger">35巻発売中（2013/04/23）</span></dd>
	    </dl>
	    </td>
	    </tr>

	    <tr><td class="img"><img class="img-thumbnail" src="img/ctitle/001.jpg"></td>
	    <td>
	    <dl>
	    <dt>ONE PIECE <span class="badge badge-d">70巻</span></dt>
	    <dd>尾田 栄一郎</dd>
		<dd>ジャンプコミックス／集英社 (2013/6/4)</dd>
		<dd><span class="text-muted">発売情報なし</span></dd>
	    </dl>
	    </td></tr>
    
	    <tr><td class="img"><img class="img-thumbnail" src="img/ctitle/002.jpg"></td>
	    <td>
	    <dl>
	    <dt>暗殺教室 <span class="badge badge-d">5巻</span></dt>
	    <dd>松井 優征</dd>
	    <dd>ジャンプコミックス／集英社 (2013/7/4)</dd>
	    <dd><span class="text-muted">発売情報なし</span></dd>
	    </dl>
	    </td></tr>
	    ...
	    <dl>
	    <dt>福本 伸行</dt>
	    <dd>賭博黙示録カイジ <span class="badge badge-d">13巻</span></dd>
	    <dd>賭博破戒録カイジ <span class="badge badge-d">13巻</span></dd>
	    <dd>賭博堕天録カイジ <span class="badge badge-d">13巻</span></dd>
	    <dd>賭博覇王伝 零 <span class="badge badge-d">8巻</span></dd>
	    </dl>
	    </td></tr>
    ...
    <div class="modal fade" id="myModal">
		...
		<tbody>
    	<tr><td class="img"><img class="img-thumbnail-data" src="img/ctitle/003.jpg"></td>
    	<td>
	    <dl>
    	<dt>バガボンド</dt>
	    <dd>井上 雄彦</dd>
